...
class SignUpCredentialsDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { username: { required: true, type: () => String, minLength: 4, maxLength: 10 }, password: { required: true, type: () => String, pattern: /((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/, minLength: 4, maxLength: 10 }, email: { required: true, type: () => String }, role: { required: true, type: () => String }, tmdb_key: { required: true, type: () => String, minLength: 15 } };
    }
}
__decorate([
